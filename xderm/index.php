...
<button type="submit" name="button1" class="glow-on-hover"  id="strp"
        value="<?php echo exec('cat log/st') ?>"/><?php echo exec('cat log/st') ?></button>
...
</table></head><center><div class="nganu slide">&copy Current versi GUI 2.6  <br>© Design by ADI-PUTRA</div></center></div>
</html>
